...
export default function EnterpriseAnalytics({ defaultTab } = {}) {
...
<Box sx={{ mt: 2 }}>
  ...
  const WorkforceTab = <WorkforceCostAnalytics />;
  ...
  const defaultTabIndex =
    Number.isFinite(Number(defaultTab))
      ? Number(defaultTab)
      : requestedView === "workforce-cost"
      ? 2
      : requestedView === "leave-readiness"
      ? 3
      : 0;
