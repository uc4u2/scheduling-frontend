...
export const NEW_BLOCKS = {
  ...
  logoCloud: () => ({
    ...
    props: {
      followSiteTheme: true,
      title: "Trusted brands / systems we work with",
      caption: "Use this rail for manufacturer brands, partner systems, or real trust labels.",
      supportingText: "Add logos or text-only labels. Leave any unsupported relationship out.",
      titleAlign: "center",
      ...
      logos: [
        {
          ...
          caption: "Equipment serviced",
          highlight: true,
        },
        {
          label: "Heating systems",
          caption: "Installation and repairs",
        },
        {
          label: "Indoor air quality",
          caption: "Maintenance programs",
        },
      ],
    },
  }),
  trustedBrandsRail: () => ({
    ...
    props: {
      ...
      title: "Trusted brands / systems we work with",
      caption:
        "Highlight manufacturer lines, certifications, associations, or text-only trust labels that are real for the business.",
      supportingText: "Everything in this rail is editable.",
      titleAlign: "center",
      supportingTextAlign: "center",
      variant: "badges",
      showLabels: true,
      maxWidth: "xl",
      logos: [
        { label: "Cooling systems", caption: "Repair and replacement" },
        { label: "Heating systems", caption: "Install and tune-ups" },
        { label: "Comfort controls", caption: "Diagnostics and upgrades", highlight: true },
        { label: "Air quality", caption: "Filtration and ventilation" },
      ],
    },
  }),
  featureShowcaseSlider: () => ({
    type: "featureShowcaseSlider",
    props: {
      eyebrow: "Popular service paths",
      title: "Compare the service paths clients ask for most",
      subtitle:
        "Use this slider for service categories, comfort problems, seasonal priorities, or maintenance options.",
      autoplay: false,
      intervalMs: 4200,
      showArrows: true,
      showDots: true,
      ...
      items: [
        {
          ...
          description: "For cooling loss, noisy systems, frozen coils, or urgent summer breakdowns.",
          badge: "Fast diagnostics",
          ctaText: "Request estimate",
          ctaLink: "?page=contact",
        },
        {
          title: "Preventive maintenance",
          description: "Reduce surprise breakdowns and keep seasonal performance on track.",
          badge: "Seasonal tune-ups",
          ctaText: "Book service",
          ctaLink: "?page=contact",
        },
        {
          title: "System replacement planning",
          description: "Compare repair versus replacement with load, efficiency, and comfort guidance.",
          badge: "Replacement options",
          ctaText: "Learn more",
          ctaLink: "?page=services-classic",
        },
      ],
