      ...
      },
{
  ...
  mapEmbed: {
    ...
    fields: [
      ...
      { name: "body",        type: "text",       label: "Body (optional)", minRows: 3 },
      ...
      { name: "detailOneText",  type: "text",    label: "Detail 1 text (optional)", minRows: 2 },
      { name: "detailTwoTitle", type: "string",  label: "Detail 2 title (optional)" },
      { name: "detailTwoText",  type: "text",    label: "Detail 2 text (optional)", minRows: 2 },
      { name: "detailThreeTitle", type: "string", label: "Detail 3 title (optional)" },
      { name: "detailThreeText",  type: "text",   label: "Detail 3 text (optional)", minRows: 2 },
