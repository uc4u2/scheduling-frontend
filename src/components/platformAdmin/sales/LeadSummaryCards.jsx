...
const cards = [
  ...
  { key: "qa_mismatch_count", label: "QA Mismatch" },
  { key: "qa_unresolved_count", label: "QA Unresolved" },
  { key: "qa_acknowledged_count", label: "QA Acknowledged" },
  { key: "qa_resolved_count", label: "QA Resolved" },
  { key: "overloaded_reps", label: "Overloaded Reps" },
