...
export const featureWhyItMatters = [
  {
    ...
    description: [
      "You do not need 34 tools. Everything lives in one platform tailored for service businesses.",
      "Built for growth: once you scale, you expand features, not systems.",
      "Designed for salons, fitness studios, clinics, agencies, HR teams, and beyond.",
      "Competitively priced for what you get: booking + payroll + websites + analytics.",
    ],
  },
];
...
export const homeFeatureSections = [
  {
    title: "Take control of every client touchpoint",
    bullets: [
      "Online checkout with saved cards",
  ...
  },
  {
    ...
    bullets: [
      "Drag-and-drop shifts and templates",
